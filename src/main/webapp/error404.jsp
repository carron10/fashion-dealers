    ...
    <% }%>
        ...
        <div id="body">
            ...
            <div style=" background-color: #666666; height: 135px; width: 100%; text-align: center" class="container-fluid text-center">
                <h5 style=" padding:50px; color: #ffffff"><b>Error! File not Found</b>
                    <p>Home/<span style=" color: #ff0000">Error404</span></p></h5>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="not-found text-center">
                                ...
                                <button onclick="loadBody('index')" class="discover-btn not-found-btn">Back To Home</button>
                            </div>
                        </div>
                    </div>
                </div>
